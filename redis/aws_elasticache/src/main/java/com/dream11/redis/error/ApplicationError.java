...
public enum ApplicationError {
  ...
  REPLICATION_GROUP_WAIT_TIMEOUT(ErrorCategory.AWS_ERROR, "Timeout waiting for Replication Group [%s] to be %s"),
  CACHE_CLUSTER_WAIT_TIMEOUT(ErrorCategory.AWS_ERROR, "Timeout waiting for Cache Cluster [%s] to be %s"),
