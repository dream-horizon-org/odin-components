...
public class Constants {
  ...
  public final Map<String, String> COMPONENT_TAGS = Map.of("component:redis:version",
  ...
  public final Duration REPLICATION_GROUP_WAIT_RETRY_TIMEOUT = Duration.ofMinutes(40);
